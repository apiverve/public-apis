...
- [Image to Text](https://apiverve.com/marketplace/imagetotext) - Image to Text is a simple tool for extracting text from images. It returns the extracted text.
...
- [DMARC Validator](https://apiverve.com/marketplace/dmarcvalidator) - DMARC Validator checks the Domain-based Message Authentication, Reporting and Conformance (DMARC) record for a domain to ensure it is correctly configured.
- [DNS Lookup](https://apiverve.com/marketplace/dnslookup) - DNS Lookup is a simple tool for looking up the DNS records of a domain. It returns the A, MX, and other records of the domain.
- [Domain Availability](https://apiverve.com/marketplace/domainavailability) - Domain Availability Checker is a simple tool for checking the availability of a domain. It returns if the domain is available or not.
- [Domain Expiration](https://apiverve.com/marketplace/domainexpiration) - Domain Expiration Checker is a simple tool for checking the expiration date and age of a domain. It returns the expiration date and age of the domain provided.
- [Fully Qualified Domain](https://apiverve.com/marketplace/fullyqualifieddomain) - Fully Qualified Domain Name is a simple tool for getting the fully qualified domain name (FQDN) of an IP. It returns the fully qualified domain name of the ip provided.
- [MX Lookup](https://apiverve.com/marketplace/mxlookup) - MX Lookup is a simple tool for getting MX records for a domain. It returns the MX records for the given domain.
- [SPF Validator](https://apiverve.com/marketplace/spfvalidator) - SPF Validator checks the Sender Policy Framework (SPF) DNS record for a domain to verify if it’s valid and optionally whether a given IP address is authorized to send emails for that domain.
- [SSL Certificate Checker](https://apiverve.com/marketplace/sslchecker) - SSL Checker is a simple tool for checking SSL certificates. It returns the SSL certificate details of a website.
- [Subdomain Finder](https://apiverve.com/marketplace/subdomainfinder) - Subdomain Finder is a simple tool for finding all the available subdomains for a given domain. It returns a list of all the available subdomains for the given domain.
- [URL Lookup](https://apiverve.com/marketplace/urllookup) - URL Lookup is a simple tool for looking up the location of a URL. It returns the location of the URL provided.
- [URL Title](https://apiverve.com/marketplace/urltitle) - URL Title is a simple tool for getting the title of a web page. It returns the title of the web page based on the URL provided.
...
- [Chuck Norris Jokes](https://apiverve.com/marketplace/chucknorris) - Chuck Norris Jokes is a simple tool for getting Chuck Norris jokes. It returns a random Chuck Norris joke.
- [Dad Jokes](https://apiverve.com/marketplace/dadjokes) - Dad Jokes is a simple tool for getting dad jokes. It returns a random dad joke.
- [Historical Events](https://apiverve.com/marketplace/historicalevents) - Historical Events is a simple tool for getting historical events. It returns a list of historical events between 300BC and 2012
- [Love Calculator](https://apiverve.com/marketplace/lovecalculator) - Love Calculator is a simple tool for calculating love compatibility. It returns the love compatibility percentage between two names.
- [Magic 8-Ball](https://apiverve.com/marketplace/magic8ball) - Magic 8-Ball is a fun tool that provides random predictions and answers like the classic toy. It returns one of 20 classic Magic 8-Ball responses categorized as affirmative, negative, or non-committal.
- [Random Facts](https://apiverve.com/marketplace/randomfacts) - Random Facts is a simple tool for getting random facts. It returns a random fact.
- [Random Joke](https://apiverve.com/marketplace/randomjoke) - Random Joke is a simple tool for getting random jokes. It returns a random joke from a collection of jokes.
- [Random Pun](https://apiverve.com/marketplace/randompun) - Random Pun is a simple tool for getting random puns. It returns a random pun from a collection of puns.
- [Random Quote](https://apiverve.com/marketplace/randomquote) - Random Quote is a simple tool for getting random quotes. It returns a random quote from a collection of quotes.
- [Scrabble Word Scorer](https://apiverve.com/marketplace/scrabblescorer) - Scrabble Word Scorer is a tool for calculating Scrabble points for words. It supports multiple languages including English, French, Spanish, German, and Italian with language-specific letter values.
...
- [Currency Symbols](https://apiverve.com/marketplace/currencysymbols) - Currency Symbols is a simple tool for getting currency symbols. It returns the currency symbol, name, and more of a currency.
- [Exchange Rate](https://apiverve.com/marketplace/exchangerate) - Exchange Rate is a simple tool for getting the current exchange rate between two currencies. It returns the current exchange rate.
- [Gold Price](https://apiverve.com/marketplace/goldprice) - Gold Price is a simple tool for getting the current price of gold. It returns the current price of gold in any currency and in various units.
- [IFSC Lookup](https://apiverve.com/marketplace/ifsclookup) - IFSC Lookup is a simple tool for getting information on IFSC codes. It returns information on various IFSC codes.
- [Loan Calculator](https://apiverve.com/marketplace/loanpaymentcalculator) - Loan Payment Calculator is a simple tool for calculating loan payments. It returns the monthly payment, total interest, and more.
- [Mortgage Calculator](https://apiverve.com/marketplace/mortgagecalculator) - Mortgage Calculator is a simple tool for calculating mortgage payments. It returns the monthly payment, total interest, and more.
- [Routing Number Lookup](https://apiverve.com/marketplace/routinglookup) - Routing Number Lookup is a simple tool for looking up routing number information for USA Banks. It returns information such as the bank, location, and more based on the routing number provided.
- [Sales Tax Lookup](https://apiverve.com/marketplace/salestax) - Sales Tax Lookup is a simple tool for looking up the sales tax rate of a location. It returns the sales tax rate.
- [Silver Price](https://apiverve.com/marketplace/silverprice) - Silver Price is a simple tool for getting the current price of silver. It returns the current price of silver in any currency and in various units.
...
- [Country Borders](https://apiverve.com/marketplace/countryborders) - Country Borders is a simple tool for getting the list of neighboring countries for a specific country. It returns the list of neighboring countries for the specified country.
- [Country Boundaries](https://apiverve.com/marketplace/countryboundaries) - Country Boundaries is a simple tool for getting the shape of a specific country's border. It returns the shape of the specified country's border.
- [Country Flags](https://apiverve.com/marketplace/countryflags) - Country Flag is a simple tool for getting the country's national flags. It returns the country's national flags.
- [Country Languages](https://apiverve.com/marketplace/countrylanguages) - Country Languages is a simple tool for getting the list of official and commonly spoken languages in a specific country.
- [Country Lookup](https://apiverve.com/marketplace/countrylookup) - Country Lookup is a simple tool for looking up country data. It returns the country name, capital, and more.
- [County Data Lookup](https://apiverve.com/marketplace/countydata) - County Data is a simple tool for getting data about US counties. It returns information such as average income, area, and more based on the county name provided.
- [Distance Calculator](https://apiverve.com/marketplace/distancecalculator) - Distance Calculator is a simple tool for calculating the distance between two locations. It returns the distance in miles and kilometers.
- [Reverse Geocode](https://apiverve.com/marketplace/reversegeocode) - Reverse Geocode is a simple tool for getting the location of a set of coordinates. Only supports USA and Canada Coordinates. It returns the city, state, and more.
- [State Boundaries](https://apiverve.com/marketplace/stateboundaries) - State Boundaries is a simple tool for getting the boundaries of a specific state's border. It returns the shape of the specified state's border.
...
- [IP Lookup](https://apiverve.com/marketplace/iplookup) - IP Lookup is a simple tool for looking up the location of an IP address. It returns the country, city, and more.
- [MAC Address Lookup](https://apiverve.com/marketplace/macaddresslookup) - MAC Address Lookup is a simple tool for looking up MAC address data. It returns the MAC address vendor, conversions, and more.
- [TLS Checker](https://apiverve.com/marketplace/tlscheck) - TLS Check is an API that inspects the TLS/SSL configuration of a server identified by its IP address. It reports supported protocols, cipher suites, and potential vulnerabilities.
...
- [Antonym Finder](https://apiverve.com/marketplace/antonym) - Antonym is a simple tool for getting the antonyms of a word. It returns a list of antonyms for the given word.
- [Cron Expression Parser](https://apiverve.com/marketplace/cronparser) - Cron Expression Parser is a comprehensive tool for parsing and validating cron expressions. It supports both 5-field and 6-field formats and returns detailed information about each field.
- [Data Masking](https://apiverve.com/marketplace/datamasking) - Data Masking is a powerful tool for detecting and masking sensitive information in text. It can identify and redact emails, phone numbers, SSNs, credit cards, IP addresses, URLs, and dates.
- [Did You Mean](https://apiverve.com/marketplace/didyoumean) - Did You Mean is a simple tool for correcting spelling mistakes. It returns the corrected text.
- [Emoji Decorator](https://apiverve.com/marketplace/emojidecorator) - Emoji Decorator is a simple tool for decorating text with emojis. It returns the text decorated with emojis.
- [Grammar Check](https://apiverve.com/marketplace/grammarcheck) - Grammar Check is a simple tool for checking the grammar and spelling of a text. It returns the corrected text.
- [ISBN Validator](https://apiverve.com/marketplace/isbnvalidator) - ISBN Validator is a comprehensive tool for validating and parsing ISBN-10 and ISBN-13 book identification numbers. It validates checksums and provides detailed information about each ISBN component.
- [JSON Schema Validator](https://apiverve.com/marketplace/jsonschemavalidator) - JSON Schema Validator is a comprehensive tool for validating JSON data against JSON Schema definitions. It provides detailed error reporting with field-level validation results.
- [Keyword Extractor](https://apiverve.com/marketplace/keywordextractor) - Keyword Extractor is a simple tool for extracting keywords from a web page. It returns the keywords and the frequency of each keyword.
- [Leet Speak](https://apiverve.com/marketplace/leetspeak) - Leet Speak is a simple tool for encoding and decoding Leet Speak. It returns the encoded or decoded Leet Speak.
- [Palindrome Checker](https://apiverve.com/marketplace/palindromechecker) - Palindrome Checker is a tool for checking if text is a palindrome. It supports options to ignore case, spaces, and punctuation, and finds the longest palindromic substring.
- [Parts Of Speech](https://apiverve.com/marketplace/partsofspeech) - Parts Of Speech is a simple tool for extracting nouns, verbs, adjectives, adverbs, etc. from text. It returns the extracted words based on the part of speech specified.
- [Pig Latin](https://apiverve.com/marketplace/piglatin) - Pig Latin is a simple tool for encoding Pig Latin. It returns the encoded Pig Latin.
- [Profanity Filter](https://apiverve.com/marketplace/profanityfilter) - Profanity Filter is a simple tool for filtering out profanity words from a text. It returns the text with the profanity words replaced by placeholders.
- [Reading Time Calculator](https://apiverve.com/marketplace/readingtime) - Reading Time Calculator estimates how long it will take to read a given text. It calculates reading time based on word count and customizable reading speed (WPM).
- [Regex Tester](https://apiverve.com/marketplace/regextester) - Regex Tester is a comprehensive tool for testing and validating regular expressions. It supports multiple operations (test, match, search, replace, split) with detailed performance analysis and pattern suggestions.
- [Remove Punctuation](https://apiverve.com/marketplace/removepunctuation) - Remove Punctuation is a simple tool for removing punctuation marks from text. It strips all common punctuation characters and provides statistics about what was removed.
- [Rhyming Words](https://apiverve.com/marketplace/wordrhymes) - Word Rhymes is a simple tool for getting word rhymes. It returns a list of rhyming words.
- [Slugify](https://apiverve.com/marketplace/slugify) - Slugify is a tool for converting text into URL-friendly slugs. It handles special characters, accents, and spaces to create clean, SEO-friendly URLs.
- [Spell Checker](https://apiverve.com/marketplace/spellchecker) - Spell Checker is a simple tool for checking spelling in a given body of text. It returns correction suggestions
- [Syllable Counter](https://apiverve.com/marketplace/syllablecounter) - Syllable Counter is a tool for counting syllables in words and text. It uses the CMU Pronouncing Dictionary for accurate syllable counting with rule-based fallback for unknown words.
- [Tax ID Validator](https://apiverve.com/marketplace/taxidvalidator) - Tax ID Validator is a comprehensive tool for validating US Tax IDs including Social Security Numbers (SSN), Employer Identification Numbers (EIN), and Individual Taxpayer Identification Numbers (ITIN).
- [Tense Converter](https://apiverve.com/marketplace/tenseconverter) - Tense Converter is a simple tool for converting text to past or future tense. It returns the text converted to the specified tense.
- [Text Language](https://apiverve.com/marketplace/textlanguage) - Text Language is a simple tool for detecting the language of a text. It returns the language code.
- [Text Lemmatizer](https://apiverve.com/marketplace/lemmatizer) - Lemmatizer is a simple tool for lemmatizing text. It returns the lemmatized text.
- [Text Readability Score](https://apiverve.com/marketplace/readabilityscore) - Readability Score is a simple tool for calculating the readability score of text. It returns the readability score based on various readability formulas.
- [Text Similarity](https://apiverve.com/marketplace/textsimilarity) - Text Similarity is a simple tool for checking the similarity between two texts. It returns the similarity score.
- [Text Styler](https://apiverve.com/marketplace/textstyler) - Text Styler is a simple tool for styling text in various ways. It returns the styled text.
- [Text Summarizer](https://apiverve.com/marketplace/textsummarizer) - Text Summarizer is a simple tool for summarizing text. It returns a summary of the text.
- [Text to Emoji](https://apiverve.com/marketplace/texttoemoji) - Text to Emoji is a simple tool for converting text into emojis. It returns the emojis that represent the given text.
- [Title Case Converter](https://apiverve.com/marketplace/titlecapitalization) - Title Capitalization is a simple tool for converting title text to various cases. It returns the text converted to your desired case.
- [Translator](https://apiverve.com/marketplace/translator) - Translator is a simple tool for translating text. It returns the translated text.
- [Website Readability](https://apiverve.com/marketplace/websitereadability) - Website Readability is a simple tool for analyzing the readability of a website. It returns the readability score of the website provided.
- [Word Lexicon Analyzer](https://apiverve.com/marketplace/lexicon) - Lexicon is a simple tool for analyzing words. It returns various properties of the word.
...
- [Moonrise Moonset](https://apiverve.com/marketplace/moonrisemoonset) - Moonrise Moonset is a simple tool for getting moonrise and moonset times. It returns the moonrise and moonset times based on the location provided.
- [Solar Potential](https://apiverve.com/marketplace/solarpotential) - Solar Potential is a simple tool for getting the estimated annual energy production of a PV system. It returns the estimated annual energy production of a PV system.
- [Sunrise Sunset](https://apiverve.com/marketplace/sunrisesunset) - Sunrise Sunset is a simple tool for getting the sunrise and sunset times. It returns the sunrise and sunset times for a given location and date.
...
| <img src="https://apiverve.web.app/publicapis/logos/antonym.svg" width="20" height="20" /> **Antonym Finder** | Antonym is a simple tool for getting the antonyms of a word. It returns a list of antonyms for the given word. | [Docs](https://docs.apiverve.com/ref/antonym) | [![Run in Postman](https://run.pstmn.io/button.svg)](https://www.postman.com/apiverve/apiverve-workspace/collection/a6utjd8/apiverve-api-collection) |

---

## 💡 Features

- ✅ **249+ Production APIs** - All tested and reliable
...
- [Advice Generator OpenAPI](apis/advice/openapi.yaml)
- [See all specs →](apis/)
